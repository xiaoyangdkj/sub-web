    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "sub.tgchuichui.xyz(chuichui提供)": "https://sub.tgchuichui.xyz/sub?",
          "subcon.dlj.tf(subconverter作者提供-稳定)":
            "https://subcon.dlj.tf/sub?",
          "api.dler.io(sub作者&lhie1提供-稳定)": "https://api.dler.io/sub?",
          "api.wcc.best(sub-web作者提供-稳定)": "https://api.wcc.best/sub?",
          "sub.id9.cc(品云转换)": "https://sub.id9.cc/sub?",
          "sub.v1.mk(肥羊转换后端)": "https://api.v1.mk/sub?",
        },
        backendOptions: [
          { value: "http://localhost:25500/sub?" },
          { value: "https://sub.tgchuichui.xyz/sub?" },
          ...
          },
          {
            ...
            options: [
              ...
              },
              {
                label: "Maoxiong",
                value:
                  "https://cdn.jsdelivr.net/gh/woshimaodaren/-sub-@main/config/maoxiong.ini"
              },
              {
                label: "NyanCAT",
                value:
